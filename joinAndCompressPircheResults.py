...
if __name__ == '__main__':
    ...
    parser.add_argument("-input", "--input", help="input directory of PIRCHE job", required=True)
    parser.add_argument("-output", "--output", help="output CSV", required=True)
    parser.add_argument("-donor", "--donor", help="character, that indicates donors", required=True)
